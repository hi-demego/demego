...
async function checkProxyServer() {
    try {
        ...
        if (response.ok) {
            ...
            useProxy = false;
            console.log('AI proxy server is not enabled. See Nerve/Localhost Servers/ai-proxy folder for our ai-proxy.js file. Fetch requests will be made through JS until the page is refreshed while the ai-proxy is running.');
        }
    } catch (error) {
        useProxy = false;
        console.log('AI proxy server is not enabled. See Nerve/Localhost Servers/ai-proxy folder for our ai-proxy.js file. Fetch requests will be made through JS until the page is refreshed while the ai-proxy is running.');
